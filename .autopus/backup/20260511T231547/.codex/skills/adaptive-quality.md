...
| **Solo** | No spawn_agent() calls. Not applicable. |
...
The complexity annotation is included in the execution plan and passed to the orchestrator before spawn_agent() calls are made.
